...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="right-side fw-700 mainNavCol">
                            ...
                            <div class="user-details p-relative">
                                <a href="#" class="text-light-white fw-500">
                                    <img src="<?php echo site_url('web/') ?>assets/img/user-1.png" class="rounded-circle" alt="userimg"> <span>Hi, Kate</span>
                                </a>
                    ...
                    <div class="col-sm-12 mobile-search">
                        ...
                        <div class="sorting-addressbox"> <span class="full-address text-light-green">Terra Roxa - Paraná</span>
                            <div class="btns">
    ...
    <section class="banner-1 p-relative">
        <img src="<?php echo site_url('web/') ?>assets/img/banner/banner-3.jpg" class="img-fluid full-width" alt="Banner">
                    ...
                    <div class="col-lg-6">
                        <div class="content-wrapper bg-white padding-20">
                            <div class="content-box padding-tb-10">
                                <h2 class="text-light-black fw-700">Find New York City restaurants near you and order online for free.</h2>
            ...
            <div class="row">
                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-links">
                        ...
                        <div class="appimg">
                            <a href="#">
                                <img src="<?php echo site_url('web/') ?>assets/img/playstore.jpg" class="img-fluid" alt="app logo">
                            </a>
                        </div>
                        <div class="appimg">
                            <a href="#">
                                <img src="<?php echo site_url('web/') ?>assets/img/appstore.jpg" class="img-fluid" alt="app logo">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="payment-logo mb-md-20"> <span class="text-light-white fs-14 mr-3">We are accept</span>
                        <div class="payemt-icon">
                            <img src="<?php echo site_url('web/') ?>assets/img/card-front.jpg" alt="#">
                            <img src="<?php echo site_url('web/') ?>assets/img/visa.jpg" alt="#">
                            <img src="<?php echo site_url('web/') ?>assets/img/amex-card-front.png" alt="#">
                            <img src="<?php echo site_url('web/') ?>assets/img/mastercard.png" alt="#">
                        </div>
                    </div>
                </div>
