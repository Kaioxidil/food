                    ...
                    <div class="category-slider swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-1.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-2.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-3.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-4.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-5.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-6.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-7.jpg" class="rounded-circle" alt="categories">
                            ...
                            <div class="swiper-slide">
                                <a href="restaurant.html" class="categories">
                                    <div class="icon text-custom-white bg-light-green ">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/125x125/cuisine-8.jpg" class="rounded-circle" alt="categories">
            ...
            <div class="row">
                    ...
                    <div class="product-box mb-md-20">
                        <div class="product-img">
                            <a href="restaurant.html">
                                <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x104/order-1.jpg" class="img-fluid full-width" alt="product-img">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product-box mb-md-20">
                        <div class="product-img">
                            <a href="restaurant.html">
                                <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x104/order-2.jpg" class="img-fluid full-width" alt="product-img">
                            </a>
                        </div>
                        <div class="product-caption">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product-box mb-md-20">
                        <div class="product-img">
                            <a href="restaurant.html">
                                <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x104/order-3.jpg" class="img-fluid full-width" alt="product-img">
                            </a>
                        </div>
                        <div class="product-caption">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="product-box mb-md-20">
                        <div class="product-img">
                            <a href="restaurant.html">
                                <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x104/order-4.jpg" class="img-fluid full-width" alt="product-img">
                            </a>
                        </div>
                        <div class="product-caption">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ex-collection-box mb-xl-20">
                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/540x300/collection-1.jpg" class="img-fluid full-width" alt="image">
                ...
                <div class="col-md-6">
                    <div class="ex-collection-box mb-xl-20">
                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/540x300/collection-2.jpg" class="img-fluid full-width" alt="image">
                        <div class="category-type overlay padding-15"> <a href="restaurant.html" class="category-btn">Top rated</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="large-product-box mb-xl-20 p-relative">
                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x587/Banner-11.jpg" class="img-fluid full-width" alt="image">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x150/shop-23.jpg" class="img-fluid full-width" alt="product-img">
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
                        <img src="<?php echo site_url('web/') ?>assets/img/svg/013-heart-1.svg" alt="tag">
                      </span>
                      ...
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/004-leaf.svg" alt="tag">
                    </span>
                                        <span class="text-custom-white square-tag">
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/006-chili.svg" alt="tag">
                    </span>
                                        <span class="text-custom-white square-tag">
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/005-chef.svg" alt="tag">
                    </span>
                                        <span class="text-custom-white square-tag">
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/008-protein.svg" alt="tag">
                    </span>
                                        <span class="text-custom-white square-tag">
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/009-lemon.svg" alt="tag">
                    </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x150/shop-2.jpg" class="img-fluid full-width" alt="product-img">
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
                        <img src="<?php echo site_url('web/') ?>assets/img/svg/013-heart-1.svg" alt="tag">
                        ...
                        <i class="fas fa-star text-yellow"></i>
                                    ...
                                    <div class="product-footer"> <span class="text-custom-white square-tag">
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/007-chili-1.svg" alt="tag">
                    </span>
                                        <span class="text-custom-white square-tag">
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/004-leaf.svg" alt="tag">
                    </span>
                      ...
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/009-lemon.svg" alt="tag">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x150/shop-3.jpg" class="img-fluid full-width" alt="product-img">
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
                        <img src="<?php echo site_url('web/') ?>assets/img/svg/013-heart-1.svg" alt="tag">
                      ...
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/004-leaf.svg" alt="tag">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x150/shop-4.jpg" class="img-fluid full-width" alt="product-img">
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
                        <img src="<?php echo site_url('web/') ?>assets/img/svg/013-heart-1.svg" alt="tag">
                      ...
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/009-lemon.svg" alt="tag">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x150/shop-5.jpg" class="img-fluid full-width" alt="product-img">
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
                        <img src="<?php echo site_url('web/') ?>assets/img/svg/013-heart-1.svg" alt="tag">
                      ...
                      <img src="<?php echo site_url('web/') ?>assets/img/svg/008-protein.svg" alt="tag">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="<?php echo site_url('web/') ?>assets/img/restaurants/255x150/shop-6.jpg" class="img-fluid full-width" alt="product-img">
                                    </a>
                                    <div class="overlay">
                                        <div class="product-tags padding-10"> <span class="circle-tag">
                        <img src="<?php echo site_url('web/') ?>assets/img/svg/013-heart-1.svg" alt="tag">
