        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mb-2">
                    <a href="<?= site_url("admin/categorias/criar"); ?>" class="btn btn-success d-flex align-items-center px-3 py-2" style="font-weight: bold;">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="py-1">
                                ...
                                <td><?=($categoria->ativo && null == $categoria->deletado_em) ? '<span class="badge badge-primary">Ativo</span>' : '<span class="badge badge-danger">Inativo</span>';?>
                                </td>
                                <td>
                                    <?=(null == $categoria->deletado_em) ? '<span class="badge badge-primary">Disponível</span>' : '<span class="badge badge-danger">Excluído</span>';?>
