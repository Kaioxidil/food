        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mb-2">
                    <a href="<?= site_url("admin/formas/criar"); ?>" class="btn btn-success d-flex align-items-center px-3 py-2" style="font-weight: bold;">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr style="cursor:pointer" onclick="window.location='<?=site_url("admin/formas/show/$forma->id");?>'">
                                <td>
                                    <?=$forma->nome;?>
                                </td>
                                <td><?=$forma->criado_em->humanize();?></td>
                                <td><?=($forma->ativo && null == $forma->deletado_em) ? '<span class="badge badge-primary">Ativo</span>' : '<span class="badge badge-danger">Inativo</span>';?>
                                </td>
                                <td>
                                    <?=(null == $forma->deletado_em) ? '<span class="badge badge-primary">Disponível</span>' : '<span class="badge badge-danger">Excluído</span>';?>

                                    <?php if (null !== $forma->deletado_em): ?>
